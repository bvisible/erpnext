...
erpnext.PointOfSale.Payment = class {
	...
	make_invoice_fields_control() {
		frappe.db.get_doc("POS Settings", "POS Settings").then((doc) => { ////
	...
	async on_numpad_clicked($btn) {
		//// Change all function to async
